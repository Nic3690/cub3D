...
/*   Updated: 2024/07/20 15:05:29 by nfurlani         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void move_forward(t_game *game)
{
    ...
    if ((game->map[(int)new_y][(int)game->pg->pos_x] == '0' || is_food(game, game->pg->pos_x, new_y)) && !is_enemy_at(game, game->pg->pos_x, new_y))
        game->pg->pos_y = new_y;
    if ((game->map[(int)game->pg->pos_y][(int)new_x] == '0' || is_food(game, new_x, game->pg->pos_y)) && !is_enemy_at(game, new_x, game->pg->pos_y))
        game->pg->pos_x = new_x;
}
