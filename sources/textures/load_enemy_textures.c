...
{
	g->tex->cat_dead = ft_calloc(1, sizeof(t_image));
	g->tex->cat_dead_2 = ft_calloc(1, sizeof(t_image));
	g->tex->cat_dead_3 = ft_calloc(1, sizeof(t_image));
	g->tex->cat_dead_4 = ft_calloc(1, sizeof(t_image));
	g->tex->cat_escape = ft_calloc(1, sizeof(t_image));
	g->tex->cat_escape_2 = ft_calloc(1, sizeof(t_image));
	g->tex->cat_escape_3 = ft_calloc(1, sizeof(t_image));
	g->tex->cat_escape_4 = ft_calloc(1, sizeof(t_image));
	g->tex->cat_escape_5 = ft_calloc(1, sizeof(t_image));
	g->tex->cat_escape_6 = ft_calloc(1, sizeof(t_image));
	g->tex->cat_face = ft_calloc(1, sizeof(t_image));
	check_malloc(g);
...
{
	g->tex->crow = ft_calloc(1, sizeof(t_image));
	g->tex->crow_open = ft_calloc(1, sizeof(t_image));
	g->tex->crow_attack = ft_calloc(1, sizeof(t_image));
	g->tex->crow_dead = ft_calloc(1, sizeof(t_image));
...
{
	g->tex->fly = ft_calloc(1, sizeof(t_image));
	g->tex->fly_open = ft_calloc(1, sizeof(t_image));
	g->tex->fly_attack = ft_calloc(1, sizeof(t_image));
	g->tex->fly_dead = ft_calloc(1, sizeof(t_image));
...
{
	g->tex->spider = ft_calloc(1, sizeof(t_image));
	g->tex->spider_2 = ft_calloc(1, sizeof(t_image));
	g->tex->spider_attack = ft_calloc(1, sizeof(t_image));
	g->tex->spider_dead = ft_calloc(1, sizeof(t_image));
